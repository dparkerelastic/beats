package device_uplinks_overview
...
func init() {
	mb.Registry.MustAddMetricSet(meraki.ModuleName, "device_uplinks_overview", New)
}
...
func New(base mb.BaseMetricSet) (mb.MetricSet, error) {
	cfgwarn.Beta("The meraki device_uplinks_overview metricset is beta.")
