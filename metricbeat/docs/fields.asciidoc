...
*`meraki.ap_radio_utilization.example`*::
+
--
Example field
...
[float]
=== cellular_gateway_health_performance

cellular_gateway_health_performance



*`meraki.cellular_gateway_health_performance.example`*::
+
--
Example field
...
*`meraki.device_health_status.example`*::
+
--
Example field
...
[float]
=== fw_performance_score

fw_performance_score



*`meraki.fw_performance_score.example`*::
+
--
Example field
...
[float]
=== fw_uplink_status_and_loss_latency

fw_uplink_status_and_loss_latency



*`meraki.fw_uplink_status_and_loss_latency.example`*::
+
--
Example field
...
[float]
=== license_expiration_state

license_expiration_state



*`meraki.license_expiration_state.example`*::
+
--
Example field
