...
|<<metricbeat-module-danslaptop,danslaptop>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-danslaptop-time,time>> beta[]  
...
|<<metricbeat-module-meraki,meraki>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.10+| .10+|  |<<metricbeat-metricset-meraki-ap_radio_utilization,ap_radio_utilization>> beta[]  
|<<metricbeat-metricset-meraki-cellular_gateway_health_performance,cellular_gateway_health_performance>> beta[]  
|<<metricbeat-metricset-meraki-device_counts,device_counts>> beta[]  
|<<metricbeat-metricset-meraki-device_health_status,device_health_status>> beta[]  
|<<metricbeat-metricset-meraki-fw_performance_score,fw_performance_score>> beta[]  
|<<metricbeat-metricset-meraki-fw_tunnels,fw_tunnels>> beta[]  
|<<metricbeat-metricset-meraki-fw_uplink_status_and_loss_latency,fw_uplink_status_and_loss_latency>> beta[]  
|<<metricbeat-metricset-meraki-ha_status,ha_status>> beta[]  
|<<metricbeat-metricset-meraki-interfaces,interfaces>> beta[]  
|<<metricbeat-metricset-meraki-license_expiration_state,license_expiration_state>> beta[]  
...
include::modules/danslaptop.asciidoc[]
